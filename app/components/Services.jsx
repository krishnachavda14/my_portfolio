...
const Services = () => {
  return (
    <div className='w-full px-[12%] py-10 scroll-mt-20' id='services'>
        ...
        <p className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'>I am a frontend developer from Bangalore, Karnataka. Looking for opportunities to grow and collaborate in a dynamic environment.</p>
